...
- `build-only`: current sources compile and pass focused unit, packaging, and real-server checks, but behavior automation is not yet sufficient for a release claim. Thirty-five exact targets—Minecraft 1.16 through 1.18.2, 1.19 through 1.19.4, 1.20 through 1.20.6, and 1.21 through 1.21.11—have this status today.
...
- allowed recipe JSON schemas and resource directories across all four audited combinations: 1.16–1.20.4 plural/object/legacy-result, 1.20.5–1.20.6 plural/object/`result.id`, 1.21–1.21.1 singular/object/`result.id`, and 1.21.2+ singular/shorthand/`result.id`
...
The root Gradle build supports `1.16`, `1.16.1`, `1.16.2`, `1.16.3`, `1.16.4`, `1.16.5`, `1.17`, `1.17.1`, `1.18`, `1.18.1`, `1.18.2`, `1.19`, `1.19.1`, `1.19.2`, `1.19.3`, `1.19.4`, `1.20`, `1.20.1`, `1.20.2`, `1.20.3`, `1.20.4`, `1.20.5`, `1.20.6`, `1.21`, `1.21.1`, `1.21.2`, `1.21.3`, `1.21.4`, `1.21.5`, `1.21.6`, `1.21.7`, `1.21.8`, `1.21.9`, `1.21.10`, `1.21.11`, `26.1`, `26.1.1`, `26.1.2`, and `26.2` as 39 independent targets. The Java 8 `1.14.4` target is isolated under `classic/1.14.4` so its old Loom, Carpet rule API, Fabric API mod id, and source set cannot leak into root artifacts. Together these are 40 exact build-ready releases. Each build pins Minecraft, Fabric Loader, Fabric API, Carpet's Maven artifact, Carpet's runtime mod version, mappings, runtime Java toolchain, recipe schema, recipe resource directory, and exact packaged dependency metadata. Minecraft 1.16–1.16.5 compile and run on Java 8, 1.17–1.17.1 on Java 16, 1.18–1.20.4 on Java 17, 1.20.5–1.21.11 on Java 21, and 26.x on Java 25.
