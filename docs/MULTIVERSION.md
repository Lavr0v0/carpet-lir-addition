...
- `build-only`: current sources compile and pass focused unit, packaging, and real-server checks, but behavior automation is not yet sufficient for a release claim. Twenty-one exact targets—Minecraft 1.19.3 through 1.19.4, 1.20 through 1.20.6, and 1.21 through 1.21.11—have this status today.
...
The active 1.19.3–1.20.6 adapters use a layered source layout: mechanics whose APIs are identical live in a shared `1.19-1.20` source layer, while divergent loot contexts, recipe lookup, fluid tags, and Mixin configuration stay in narrow overlays. Minecraft 1.19.3–1.20.1 use the pre-`RecipeEntry` API, whose cached fallback returns `Pair<Identifier, Recipe>`; Minecraft 1.20.2–1.20.4 use `Pair<Identifier, RecipeEntry>`. Minecraft 1.19.3/1.19.4 retain `LootContext.Builder` while selecting registry `FluidTags`. This avoids duplicating stable feature code without pretending incompatible APIs are interchangeable.
...
The root Gradle build supports `1.19.3`, `1.19.4`, `1.20`, `1.20.1`, `1.20.2`, `1.20.3`, `1.20.4`, `1.20.5`, `1.20.6`, `1.21`, `1.21.1`, `1.21.2`, `1.21.3`, `1.21.4`, `1.21.5`, `1.21.6`, `1.21.7`, `1.21.8`, `1.21.9`, `1.21.10`, `1.21.11`, `26.1`, `26.1.1`, `26.1.2`, and `26.2` as 25 independent targets. The Java 8 `1.14.4` target is isolated under `classic/1.14.4` so its old Loom, Carpet rule API, Fabric API mod id, and source set cannot leak into modern artifacts. Together these are 26 exact build-ready releases. Each build pins Minecraft, Fabric Loader, Fabric API, Carpet's Maven artifact, Carpet's runtime mod version, mappings, Java bytecode, recipe schema, recipe resource directory, and exact packaged dependency metadata. Minecraft 1.19.3–1.20.4 compile for Java 17, 1.20.5–1.21.11 compile for Java 21, and 26.x compile for Java 25.
