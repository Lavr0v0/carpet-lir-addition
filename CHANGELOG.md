...
- Extended full disposable real-server coverage through both exact Minecraft 1.17 releases, including declared-Java verification, dirt and calcite gates, cached/direct recipe fallback, piston no-drop/drop behavior, clean shutdown, and automatic world cleanup.
